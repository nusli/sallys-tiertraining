...
export class ImpressumComponent implements OnInit, AfterViewInit{
  ...
  agbTexts = [
    ...
    },
    {
      ...
      erhobenen Daten zu dem Zweck, Rückschlüsse auf Ihre Person zu ziehen. Darüber hinaus setzen wir
      beim Besuch unserer Website Cookies sowie Analysedienste ein. Nähere Erläuterungen dazu
      erhalten Sie unter den Ziff. 3 und 4 dieser Datenschutzerklärung.`,
    },
    {
